    ...
    setTimeout(function(){
      if(nextStep==="step3"){
        if(counterStep==="step2a"){
          ...
          formatTime = "hh:mm A";
          message= "<p>Nếu bạn muốn dậy lúc <span class='green bold'>"+timeString+"</span> bạn hãy cố gắng <span class='red bold'>đi ngủ*</span> ở một trong những khoảng thời gian sau: </p>";
          ...
          timeString = hour.concat(":",minute," "+timelapse);
          formatTime = "hh:mm A";
          message= "<p>Nếu bạn muốn ngủ lúc <span class='green bold'>"+timeString+"</span> bạn hãy cố gắng <span class='red bold'>thức dậy</span> ở một trong những khoảng thời gian sau: </p>";
