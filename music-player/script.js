$(function()
{
    ...
    //use Song name for "album-name"//
    albums = ['Dawn','Me & You','Electro Boy','Home','Proxy (Original Mix)'], 

    //use use Artist for "track-name"//
